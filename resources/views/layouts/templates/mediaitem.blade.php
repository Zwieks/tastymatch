...
<div class="media">
    <div class="product-wrapper">
        ...
        <figure data-toggle="modal" data-target="#modal-media" data-content="{{ ( $data['video'] != '' ? $data['video'] : URL::asset('storage/app/public/'.$data['image'])) }}" data-type="{{ ( $data['video'] != '' ? 'video' : 'image' ) }}" class="{{ ( $data['video'] != '' ? 'youtube-playbtn' : 'image-wrapper' )}}">
