...
@if( isset($page_content['getLocationdetails']['eventlocation']) ||
	(isset($page_content['getAdditionalinfo']['type']) && $page_content['getAdditionalinfo']['type'] != 'placeholder') ||
	isset($page_content['getAdditionalinfo']['eventdatestart']) || 
	isset($page_content['getAdditionalinfo']['eventdateend']) ||
	isset($page_content['getAdditionalinfo']['filter_visitors']))
	...
	<div class="content product-wrapper details detailpage-items">
		...
		@if( isset($page_content['getAdditionalinfo']['type']) && $page_content['getAdditionalinfo']['type'] != 'placeholder')
		    <section class="detailitem-wrapper">
